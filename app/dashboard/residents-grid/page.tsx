...
export default function ResidentsGridPage() {
  ...
  const getGridClass = () => {
    ...
    if (count <= 12)
      ...
      return "grid-cols-2 sm:grid-cols-6 md:grid-cols-8 lg:grid-cols-10";
    else
      return "grid-cols-2 sm:grid-cols-7 md:grid-cols-10 lg:grid-cols-12 xl:grid-cols-14";
  };
        ...
        <div className="hidden print:block print-container">
          {(() => {
            ...
            const renderResidentCard = (resident: ResidentGrid, keyPrefix: string) => (
              <div key={`${keyPrefix}-${resident.id}`} className="print-resident-card" style={{ position: 'relative' }}>
