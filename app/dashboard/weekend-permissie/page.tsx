        ...
        <div className="mb-6">
          <div className="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-4 mb-4 border dark:border-gray-700">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
              {/* Title */}
              <div className="bg-gradient-to-r from-purple-500 to-purple-600 px-3 py-2 text-center font-semibold rounded-lg shadow-lg">
                <div className="text-lg md:text-xl font-bold text-white drop-shadow-md">WEEKEND PERMISSIE</div>
                <div className="text-sm mt-1 text-purple-100">
                  Week {currentWeek.split('-W')[1]} - {currentWeek.split('-W')[0]}
                  {isHolidayWeek && <span className="ml-2 px-2 py-1 bg-yellow-400 text-yellow-900 rounded text-xs font-bold">FEESTDAG</span>}
                </div>
                {saveStatus && (
            ...
            <table className="min-w-full text-xs">
              <thead className="bg-gradient-to-r from-purple-600 to-purple-700 text-white">
                <tr>
                  ...
                  <th className="px-2 py-3 text-left font-bold border-r border-purple-500 text-shadow">Opmerkingen</th>
                  <th className="px-2 py-3 text-center font-bold text-shadow">Status</th>
                </tr>
              </thead>
              <tbody>
                {permissions
                        ...
                        <div className="space-y-1">
                          ...
                          {permission.monday.type !== 'none' && (
                            <div className="grid grid-cols-2 gap-1">
                              {renderEditableCell(permission.residentId, 'monday.departureTime', permission.monday.departureTime || '', 'time', undefined, (isMinor || isNewResident))}
                              {renderEditableCell(permission.residentId, 'monday.returnTime', permission.monday.returnTime || '', 'time', undefined, (isMinor || isNewResident))}
                            </div>
                          )}
                        </div>
                      </td>
                    ...
                    <td className="px-2 py-2">
                      <div className="space-y-1">
                        ...
                        <div className="text-xs">
                          <label className={`block mb-1 ${(isMinor || isNewResident) ? 'text-white' : 'text-gray-600 dark:text-gray-400'}`}>Aankomst:</label>
                          {renderEditableCell(permission.residentId, 'actualArrivalTime', permission.actualArrivalTime || '', 'time', undefined, (isMinor || isNewResident))}
                        </div>
                        {/* Status Display */}
                        <div className={`text-xs font-bold px-2 py-1 rounded-md text-center shadow-sm ${
