...
export default function WeekendPermissiePage() {
  ...
  const renderEditableCell = (residentId: number, field: string, value: string, type: 'text' | 'time' | 'select' = 'text', options?: string[]) => {
    ...
    return (
      <div
        className="cursor-pointer px-1 py-1 rounded text-xs flex items-center justify-between group transition-all text-gray-900 dark:text-gray-100"
        ...
        className={`w-full px-1 py-1 text-xs border-2 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-400 transition-all ${
          isUnder16Resident 
            ...
            : dayPermission?.type === 'daily'
              ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white border-blue-400 font-bold shadow-sm'
            ...
            <table className="min-w-full text-xs">
              ...
              <tbody>
                {permissions
                  ...
                  >
                    <td className="px-2 py-2 font-medium border-r border-gray-200 dark:border-gray-600 text-gray-900 dark:text-gray-100">{permission.badge}</td>
                    <td className="px-2 py-2 border-r border-gray-200 dark:border-gray-600 text-gray-900 dark:text-gray-100">{permission.lastName}</td>
                    <td className="px-2 py-2 border-r border-gray-200 dark:border-gray-600 text-gray-900 dark:text-gray-100">{permission.firstName}</td>
                    <td className="px-2 py-2 border-r border-gray-200 dark:border-gray-600 text-gray-900 dark:text-gray-100">{formatDate(permission.dateOfBirth)}</td>
                    <td className="px-2 py-2 border-r border-gray-200 dark:border-gray-600 text-gray-900 dark:text-gray-100">{permission.age}</td>
        ...
        <div className="mt-4 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 p-4 rounded-lg shadow-md border-2 border-purple-200 dark:border-purple-700">
          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 bg-gradient-to-r from-blue-500 to-blue-600 border-2 border-blue-400 rounded shadow-sm"></div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 bg-red-400 dark:bg-red-600 border-2 border-red-500 dark:border-red-700 rounded shadow-sm"></div>
                <span className="text-gray-700 dark:text-gray-300">
                  <strong className="text-red-700 dark:text-red-400">Rood:</strong> Onder 16 jaar (geen permissies toegestaan)
                </span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 bg-green-400 dark:bg-green-600 border-2 border-green-500 dark:border-green-700 rounded shadow-sm"></div>
                <span className="text-gray-700 dark:text-gray-300">
                  <strong className="text-green-700 dark:text-green-400">Groen:</strong> Nieuwe bewoner (≤7 dagen aanwezig)
                </span>
              </div>
              <div className="flex items-center gap-3">
