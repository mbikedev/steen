              ...
              <div className="mb-6 p-6 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="mt-6">
                  <h4 className="text-md font-semibold mb-3 text-gray-900 dark:text-white">
                    Vul de datum en tijdstip in (dit wordt automatisch weerspiegeld in de printversie)
                  </h4>
                  <div className="border-2 border-gray-700 dark:border-gray-600 rounded-lg overflow-hidden">
                    <div className="bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-700 dark:to-gray-600 p-3 border-b-2 border-gray-700 dark:border-gray-600">
                    ...
                    <table className="w-full border-collapse">
                      <thead>
                        <tr className="border-b border-gray-600">
                          <th
                            colSpan={2}
                            className="border-r border-gray-600 p-3 text-center bg-blue-50 dark:bg-blue-900/20 text-base font-semibold text-blue-900 dark:text-blue-300"
                          >
                            Kleine permissie
                          </th>
                          <th
                            colSpan={2}
                            className="border-r border-gray-600 p-3 text-center bg-green-50 dark:bg-green-900/20 text-base font-semibold text-green-900 dark:text-green-300"
                          >
                            Permissie weekend/feestdagen
                          </th>
                          <th
                            colSpan={2}
                            className="p-3 text-center bg-orange-50 dark:bg-orange-900/20 text-base font-semibold text-orange-900 dark:text-orange-300"
                          >
                            Afspraken
                          </th>
                        </tr>
                        <tr className="border-b border-gray-600">
                          <td className="border-r border-gray-600 p-2 text-center text-sm bg-white dark:bg-gray-800 font-bold">
                            Tot : (datum)
                          </td>
                          <td className="border-r border-gray-600 p-2 text-center text-sm bg-white dark:bg-gray-800 font-bold">
                            (uur)
                          ...
                          <td className="p-2 text-center text-sm bg-white dark:bg-gray-800 font-bold">
                            (uur)
                          </td>
                        </tr>
                      </thead>
                      <tbody>
                        {[...Array(11)].map((_, rowIndex) => (
                          <tr
                            key={rowIndex}
                            className={`${rowIndex === 10 ? "border-b-2 border-gray-700 dark:border-gray-600" : "border-b border-gray-600"}`}
                          >
                            <td className="border-r border-gray-600 p-2 bg-white dark:bg-gray-800">
                              <input
                                type="date"
                                value={editablePermissions[selectedResident.id]?.[rowIndex]?.smallDate || ''}
                                onChange={(e) => {
                                  setEditablePermissions(prev => ({
                                    ...prev,
                                    [selectedResident.id]: {
                                      ...prev[selectedResident.id],
                                      [rowIndex]: {
                                        ...prev[selectedResident.id]?.[rowIndex],
                                        smallDate: e.target.value
                                      }
                                    }
                                  }));
                                }}
                            ...
                            <td className="border-r border-gray-600 p-2 bg-white dark:bg-gray-800">
                              <input
                                type="time"
                                value={editablePermissions[selectedResident.id]?.[rowIndex]?.smallTime || ''}
                                onChange={(e) => {
                                  setEditablePermissions(prev => ({
                                    ...prev,
                                    [selectedResident.id]: {
                            ...
                            <td className="border-r border-gray-600 p-2 bg-white dark:bg-gray-800">
                              <input
                                type="date"
                                value={editablePermissions[selectedResident.id]?.[rowIndex]?.weekendDate || ''}
                                onChange={(e) => {
                                  setEditablePermissions(prev => ({
                                    ...prev,
                                    [selectedResident.id]: {
                            ...
                            <td className="border-r border-gray-600 p-2 bg-white dark:bg-gray-800">
                              <input
                                type="time"
                                value={editablePermissions[selectedResident.id]?.[rowIndex]?.weekendTime || ''}
                                onChange={(e) => {
                                  setEditablePermissions(prev => ({
                                    ...prev,
                                    [selectedResident.id]: {
                            ...
                            <td className="border-r border-gray-600 p-2 bg-white dark:bg-gray-800">
                              <input
                                type="date"
                                value={editablePermissions[selectedResident.id]?.[rowIndex]?.appointmentDate || ''}
                                onChange={(e) => {
                                  setEditablePermissions(prev => ({
                                    ...prev,
                                    [selectedResident.id]: {
                            ...
                            <td className="p-2 bg-white dark:bg-gray-800">
                              <input
                                type="time"
                                value={editablePermissions[selectedResident.id]?.[rowIndex]?.appointmentTime || ''}
                                onChange={(e) => {
                                  setEditablePermissions(prev => ({
                                    ...prev,
                                    [selectedResident.id]: {
                  ...
                  <div className="text-base mb-4 print:mb-2 print:text-sm bg-white border border-gray-200 rounded-lg p-6 shadow-sm print:border-none print:shadow-none print:p-0">
                    ...
                    <div className="mb-6 print:mb-2">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 space-y-3 print:space-y-1 bg-blue-50 p-4 rounded-lg border border-blue-200 print:bg-white print:border-none print:p-0">
                        ...
                        {/* Modern Center Stamp - Box Layout */}
                        <div className="flex-shrink-0 mr-32">
                          <div className="relative inline-block flex items-center gap-1">
                            {/* Vertical STEMPEL text */}
                            <div className="text-xs print:text-[10px] font-bold text-gray-900 tracking-wider" style={{ writingMode: 'vertical-rl', textOrientation: 'upright' }}>
                              STEMPEL
                            </div>
                            {/* Stamp box with thick border */}
                            <div className="border-4 border-black p-2 bg-white shadow-lg print:shadow-none w-44 print:w-40">
                              <div className="text-center space-y-1">
                                <div className="text-[9px] print:text-[8px] font-bold uppercase tracking-wide">
                                  <span className="text-amber-700">fed</span>
                                  <span className="text-red-600">a</span>
                                  <span className="text-red-600">sil</span>
                                </div>
                                <div className="text-[7px] print:text-[6px] font-bold uppercase tracking-wider text-amber-700">
                                  FEDERAAL AGENTSCHAP
                                </div>
                                <div className="text-[9px] print:text-[8px] font-bold text-gray-900 leading-tight">
                                  OOC STEENOKKERZEEL
                                </div>
                                <div className="text-[7px] print:text-[6px] text-gray-800 leading-tight">
                                  Keizerinlaan 2<br />
                                  1820 Steenokkerzeel
                                </div>
                                <div className="text-[7px] print:text-[6px] font-semibold text-gray-800 pt-0.5">
                                  ☎ +32 2 755 23 60
                                </div>
                              </div>
                            </div>
                  ...
                  <div className="border-2 border-gray-700  print:compact-table bg-white rounded-lg shadow-sm overflow-hidden print:border-black print:shadow-none">
                    ...
                    <table className="w-full border-collapse border-b-2 border-gray-700 print:border-black">
                      <thead>
                        ...
                        <tr className="border-b border-gray-600 print:border-gray-800">
                          <td className="border-r border-gray-600 print:border-gray-800 p-2 print:p-1 text-center text-base print:text-sm font-bold">
                            Tot : (datum)
                          </td>
                          <td className="border-r border-gray-600 print:border-gray-800 p-2 print:p-1 text-center text-base print:text-sm font-bold">
                            (uur)
                          ...
                          <td className="p-2 print:p-1 text-center text-base print:text-sm font-bold">
                            (uur)
                          </td>
                        </tr>
                      </thead>
                          ...
                          >
                            <td className="border-r border-gray-600 print:border-gray-800 p-3 h-20 print:p-1 print:h-7">
                              <div className="text-xs text-center text-gray-900 dark:text-gray-100">
                                {editablePermissions[resident.id]?.[rowIndex]?.smallDate || ''}
                              </div>
                            </td>
                            <td className="border-r border-gray-600 print:border-gray-800 p-3 h-20 print:p-1 print:h-7">
                              <div className="text-xs text-center text-gray-900 dark:text-gray-100">
                                {editablePermissions[resident.id]?.[rowIndex]?.smallTime || ''}
                              </div>
                            </td>
                            <td className="border-r border-gray-600 print:border-gray-800 p-3 h-20 print:p-1 print:h-7">
                              <div className="text-xs text-center text-gray-900 dark:text-gray-100">
                                {editablePermissions[resident.id]?.[rowIndex]?.weekendDate || ''}
                              </div>
                            </td>
                            <td className="border-r border-gray-600 print:border-gray-800 p-3 h-20 print:p-1 print:h-7">
                              <div className="text-xs text-center text-gray-900 dark:text-gray-100">
                                {editablePermissions[resident.id]?.[rowIndex]?.weekendTime || ''}
                              </div>
                            </td>
                            <td className="border-r border-gray-600 print:border-gray-800 p-3 h-20 print:p-1 print:h-7">
                              <div className="text-xs text-center text-gray-900 dark:text-gray-100">
                                {editablePermissions[resident.id]?.[rowIndex]?.appointmentDate || ''}
                              </div>
                            </td>
                            <td className="p-3 h-20 print:p-1 print:h-7">
                              <div className="text-xs text-center text-gray-900 dark:text-gray-100">
                                {editablePermissions[resident.id]?.[rowIndex]?.appointmentTime || ''}
                              </div>
                            </td>
                          </tr>
                        ))}
