      ...
      <div className="p-6">
        ...
        <div className="space-y-6 mb-12">
          <div className="mb-6 pb-4 border-b-4 border-primary">
            <h2 className="text-2xl font-bold text-primary">Grond</h2>
        ...
        <div className="page-break space-y-6 mt-12">
          <div className="mb-6 pb-4 border-b-4 border-primary">
            <h2 className="text-2xl font-bold text-primary">Verdieping</h2>
          ...
          {firstFloorRoomsForDisplay.map(room => {
            if (room === medicalRoomNumber) {
              ...
              return (
                <div key={room} className="bg-card shadow-lg rounded-lg overflow-hidden border-4 border-red-600 mb-8">
                  {/* Room Header */}
                  <div className="bg-red-600 px-6 py-4 border-b-4 border-red-600">
                    <h3 className="text-xl font-bold text-white text-center tracking-wider">MED</h3>
            ...
            return (
              <div key={room} className="bg-card shadow-lg rounded-lg overflow-hidden border-4 border-primary mb-8">
                {/* Room Header */}
                <div className="bg-primary px-6 py-4 border-b-4 border-primary">
                  <h3 className="text-xl font-bold text-primary-foreground">Kamer {room}
                  </h3>
                  <p className="text-sm text-primary-foreground/80">{roomResidents.length} van {maxBeds} bedden bezet</p>
                </div>
          ...
          <tbody>
            {groundRoomsForDisplay.map(room => {
              ...
              return Array.from({ length: maxBeds }, (_, bedIndex) => {
                ...
                const rowBgColor = isEmpty ? '#f0f9ff' : (bedIndex % 2 === 0 ? '#ffffff' : '#e0f2fe');
