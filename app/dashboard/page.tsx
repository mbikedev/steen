...
function DashboardPage() {
  ...
  useEffect(() => {
    ...
    const quickStats: QuickStat[] = [
      ...
      },
      {
        ...
        value: Math.round(currentStats.occupancyRate || 0),
        change: 0,
        trend: 'up',
  ...
  // Use default values if dashboardStats is not available
  ...
  // Create occupancy structure from stats
  const totalOccupied = stats.occupiedRooms || 0;
  const totalBeds = stats.totalRooms || 50;
