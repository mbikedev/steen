...
export default function BadgeGenerator({
  ...
  return (
    <div className="badge-generator">
      {/* Badge Preview */}
      <div className="badge-preview mb-4 sm:mb-6">
        <h3 className="text-base sm:text-lg font-bold mb-2 sm:mb-3">Badge Preview</h3>
        <div className="overflow-x-auto pb-2">
          <div className="inline-block min-w-full">
            <div
              ref={badgeRef}
              className="badge-container mx-auto"
              style={{
                width: "85.6mm",
                height: "54mm",
                ...
                transform: isMobile ? `scale(${Math.min(1, (typeof window !== 'undefined' ? window.innerWidth - 48 : 320) / 323)})` : 'none',
      ...
      {/* Controls */}
      <div className="badge-controls flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
        <input
          ref={fileInputRef}
          type="file"
          accept="image/*"
        ...
        <button
          ...
          className="px-3 py-2 sm:px-4 text-sm sm:text-base bg-blue-600 text-white rounded hover:bg-blue-700 flex items-center gap-2 justify-center"
        >
        ...
        <button
          onClick={handlePrint}
          className="px-4 py-2 sm:px-6 sm:py-3 text-sm sm:text-base bg-green-600 text-white rounded-lg hover:bg-green-700 flex items-center gap-2 justify-center"
        >
