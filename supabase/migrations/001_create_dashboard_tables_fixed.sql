...
CREATE INDEX IF NOT EXISTS idx_residents_admission_date ON public.residents(admission_date);
CREATE INDEX IF NOT EXISTS idx_beds_status ON public.beds(status);
CREATE INDEX IF NOT EXISTS idx_beds_location ON public.beds(location);
CREATE INDEX IF NOT EXISTS idx_appointments_date ON public.appointments(appointment_date);
CREATE INDEX IF NOT EXISTS idx_appointments_resident ON public.appointments(resident_id);
CREATE INDEX IF NOT EXISTS idx_kitchen_list_date ON public.kitchen_list(meal_date);
CREATE INDEX IF NOT EXISTS idx_permissions_resident ON public.permissions(resident_id);
...
-- Basic RLS policies (will be replaced by more permissive ones in migration 002)
